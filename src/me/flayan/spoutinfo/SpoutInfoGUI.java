...
public class SpoutInfoGUI {
	...
	public void openMainOverlay(SpoutPlayer player){
		...
		plugin.mainpopup.attachWidget(plugin, ((GenericLabel) new GenericLabel(plugin.config.getString("label.text")).setHexColor(Integer.parseInt(plugin.config.getString("label.color"), 16)).setAlignY(Align.FIRST)).setAlignX(Align.FIRST).setX(5).setY(20).setHeight(240).setWidth(427));
